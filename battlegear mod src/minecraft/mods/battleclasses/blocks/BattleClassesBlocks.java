...
public class BattleClassesBlocks implements IWorldGenerator
{
	public static BattleClassesBlocks worldGenerator = new BattleClassesBlocks();
	public static BattleClassesBlockOreGem blockGemsOre = new BattleClassesBlockOreGem();
	
	public static void registerBlocks() {
		GameRegistry.registerBlock(blockGemsOre, "gemsOreBlock");
		
		LanguageRegistry.addName(blockGemsOre, "Gem Ore");
	}
	...
	{
		this.addOreSpawn(blockGemsOre, world, random, x, z, 16, 16, 3 + random.nextInt(2), 2, 3, 15);
	}
