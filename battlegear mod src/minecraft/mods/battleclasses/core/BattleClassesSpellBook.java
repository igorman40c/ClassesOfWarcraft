	...
	public void learnAbility(BattleClassesAbstractAbility ability) {
		if(ability instanceof BattleClassesAbstractAbilityActive) {
			...
			if(!this.activeAbilities.containsValue(activeAbility)) {
				...
				this.playerHooks.mainCooldownMap.put(activeAbility.getCooldownHashCode(), activeAbility);
			...
			if(hasAbility(passiveAbility)) {
				...
				//this.playerHooks.mainCooldownMap.put(passiveAbility.getCooldownHashCode(), passiveAbility);
	...
	public void unLearnAbility(BattleClassesAbstractAbility ability) {
		if(ability instanceof BattleClassesAbstractAbilityActive) {
			...
			if(hasAbility(activeAbility)) {
				...
				this.playerHooks.mainCooldownMap.remove(activeAbility.getAbilityID());
			...
			if(hasAbility(passiveAbility)) {
				...
				//this.playerHooks.mainCooldownMap.remove(passiveAbility.getAbilityID());
